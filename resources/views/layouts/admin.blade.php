        ...
        <aside class="fixed inset-y-0 left-0 z-30 w-64 bg-orange-600 text-white flex flex-col transition-transform -translate-x-full lg:translate-x-0">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <a href="{{ route('admin.meja.index') }}"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('admin.meja.*') ? 'bg-orange-700 text-white' : 'text-orange-100 hover:bg-orange-500 hover:text-white' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
